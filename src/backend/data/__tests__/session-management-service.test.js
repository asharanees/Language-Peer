...
describe('DynamoDBSessionManagementService', () => {
    ...
    beforeEach(() => {
        ...
        sessionService = new session_management_service_1.DynamoDBSessionManagementService('test-sessions-table', 'us-east-1');
        sessionService.dynamoClient = mockDynamoClient;
        // Mock session
        mockSession = {
