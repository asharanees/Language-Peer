import { DynamoDBUserProfileService, CreateUserProfileRequest, UpdateUserProfileRequest } from '../user-profile-service';
import { DynamoDBDocumentClient, GetCommand, PutCommand, UpdateCommand, DeleteCommand, ScanCommand } from '@aws-sdk/lib-dynamodb';
import { UserProfile, LanguageLevel, Milestone } from '@/shared/types';
...
describe('DynamoDBUserProfileService', () => {
  let userProfileService: DynamoDBUserProfileService;
  ...
  beforeEach(() => {
    ...
    userProfileService = new DynamoDBUserProfileService('test-users-table', 'us-east-1');
  ...
  describe('searchUsers', () => {
    ...
    test('handles single criterion search', async () => {
      const criteria = {
        currentLevel: 'advanced' as LanguageLevel
      };
