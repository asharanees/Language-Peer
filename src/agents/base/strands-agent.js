...
exports.StrandsAgent = void 0;
const bedrock_client_1 = require("@/backend/services/bedrock-client");
class StrandsAgent {
    constructor(personality, region) {
        this.conversationState = new Map();
        this.personality = personality;
        this.bedrockService = new bedrock_client_1.BedrockService(region);
    }
    /**
    ...
    async generateSupportiveResponse(context) {
        try {
            ...
            const bedrockResponse = await this.bedrockService.invokeModel(systemPrompt, userMessage, context);
     ...
     */
    async analyzeUserEmotionalState(context) {
     ...
     */
    adaptToUserEmotionalState(userState) {
     ...
     */
    async provideEncouragement(userProgress) {
     ...
     */
    async detectUserFrustration(conversationHistory) {
     ...
     */
    buildSystemPrompt(context, emotionalState) {
     ...
     */
    generateAudioInstructions(content) {
        return {
     ...
     */
    determineEmotionalTone(emotionalState) {
     ...
     */
    shouldSuggestNewTopic(context, emotionalState) {
     ...
     */
    updateConversationState(key, value) {
...
exports.StrandsAgent = StrandsAgent;
